...
// #optimize: initialize latest scroll position to 0 and switch to true
...
function updatePositions() {
  ...
  for (i = 0; i < 5; i++) {
    phaseArray.push(Math.sin(top + i % 5));
  }
...
// runs updatePositions on scroll, #optimize: change callback function to `onScroll`
